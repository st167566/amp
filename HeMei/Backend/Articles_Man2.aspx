<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/User.master" AutoEventWireup="true" CodeFile="Articles_Man2.aspx.cs" Inherits="Backend_Articles_Man2" %>
...
<a id="morechose" data-toggle="collapse" data-parent="#accordion" href="#collapseexample"><i class="glyphicon glyphicon-chevron-down"></i><span>展开更多筛选</span><i class="glyphicon glyphicon-chevron-down"></i>
    ...
    <script src="assets/js/Articles_Man_yzt.js" type="text/javascript"></script>
</asp:Content>
