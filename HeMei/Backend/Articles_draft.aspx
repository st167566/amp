<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/User.master" AutoEventWireup="true" CodeFile="Articles_draft.aspx.cs" Inherits="Backend_Articles_draft" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding-right: 50px;" id="box">
        ...
        <%--面包屑导航--%>
        <div id="CurrentPosition">当前位置：<a href="#">文章模块</a> >>  <a href="Article_Man.aspx">草稿箱</a></div>
        <%--主面板开始--%>
        <div class="page-body">
            <div class="row">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="Man_Nav" class="col-lg-12">
                            ...
                            <input type="button" id="AddBtn" class="btn btn-success" value="新建文章" />
                            </div>
                            <div class="col-lg-12">
...
<a id="morechose" data-toggle="collapse" data-parent="#accordion" href="#collapseexample"><i class="glyphicon glyphicon-chevron-down"></i><span>展开更多筛选</span><i class="glyphicon glyphicon-chevron-down"></i>
            ...
            <div class="modal-dialog " role="document" style="width: 800px;">
                <div class="modal-content" style="margin-top: 15%;">
                    ...
                    <div class="modal-body" style="padding: 25px 25px 0 25px;">
                       <span class="form-inline">
                           <span>您即将移动到</span>
                                    <select id="move_cat" class="form-control" v-model="catmove">
                                        <option v-for="citem in catitems" v-bind:value="citem.ID">{{citem.CatName}}</option>
                                    </select>
                                </span>
                                <span class="form-inline">
                                    <select id="move_sub" class="form-control" v-if="has1">
                                        <option v-for="sitem in submoveitems" v-bind:value="sitem.ID">{{sitem.SubName}}</option>
                                    </select>
                                </span>
                        
                    </div>
                    <div class="modal-footer">
                        <input type="button" value="确定移动" onclick="moveArticles()" class="btn btn-success" style="margin: 0 5px" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="assets/js/Articles_draft_yzt.js" type="text/javascript"></script>
</asp:Content>
